...
export function Logo({ className }: { className?: string }) {
  return (
    <svg
      ...
      className={className}
    >
      {/* Trunk (Brass) - Truncated to start slightly below top thread */}
      <path
        d="M12 7.8V23"
        stroke="#f59e0b"
        strokeWidth="2"
      ...
      {/* Bulb Shape (Bright Yellow) - Translated Down */}
      <path
      ...
      <g stroke="#cbd5e1" strokeWidth="0.6" strokeLinecap="round">
        ...
        <rect
          ...
          stroke="none"
        />
        {/* Pupil: Play Triangle (Slightly Larger) - Red */}
        <path d="M11.6 5.1L11.6 5.9L12.4 5.5Z" fill="#ef4444" stroke="none" />
      </g>

      {/* Radiating Rays (Bright Yellow) - Translated Down */}
      ...
      {/* Tree Branches (Green, Angled Down) - Shifted Up & Aligned Angles */}
      <g className="text-emerald-500">
        {/* Level 1 - Symmetrical (Slope 0.6) */}
        <path
          d="M12 9L7 12"
          stroke="currentColor"
          strokeWidth="2"
        ...
        {/* Ornaments - Pascal's Triangle (1, 2, 3) with Tip Placement & Even Spacing */}
        {/* Level 1 - 1 Ornament at Tip (x=7 and x=17) */}
        <g>
          {/* Left L1 - Star (x=7, y=12) */}
          <path
        ...
        {/* Level 2 - 2 Ornaments (Tip & Halfway) */}
        {/* Left L2: Tip (5, 17.2), Halfway (8.5, 15.1) */}
        <g>
          {/* Tip Circle (x=5, y=17.2) */}
          <circle
            cx="5"
            cy="17.2"
            r="0.9"
        ...
        {/* Right L2: Tip (19, 17.2), Halfway (15.5, 15.1) */}
        <g>
          {/* Tip Square (x=19, y=17.2) */}
          <rect
            x="17.85"
            y="16.05"
            width="2.3"
        ...
        {/* Level 3 - 3 Ornaments (Tip, Middle, Inner) */}
        {/* Left L3: Tip (3, 22.4), Middle (7, 20), Inner (11, 17.6) */}
        <g>
          {/* Tip Square (x=3, y=22.4) */}
          <rect
            x="1.85"
            y="21.25"
            width="2.3"
        ...
        <g>
          {/* Middle Star (x=7, y=20) - Lines up with L1 Star (x=7) */}
          <path
        ...
        {/* Right L3 - NO ORNAMENTS (Key Tooth Area) */}
        <g />
      </g>

      {/* Bottom Right: Key Tooth (Brass/Yellow, Jagged) - Shifted Down */}
      ...
      {/* Threaded Base (Silver) - Highest Z-Index (on top of branches) */}
