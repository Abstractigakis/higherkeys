...
// Image metadata
export const alt = "Higher Keys - Organize your thoughts";
export const size = {
  width: 1200,
  height: 630,
};
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <div style={{ fontSize: 72, fontWeight: "bold", color: "#1e293b" }}>
            Higher Keys
          </div>
          <div style={{ fontSize: 32, color: "#64748b", marginTop: 10 }}>
            Organize your thoughts with hierarchical labels.
          </div>
        </div>
      </div>
    ),
